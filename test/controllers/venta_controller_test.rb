...
class VentaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ventum" do
    assert_difference('Ventum.count') do
      post venta_url, params: { ventum: { cantidad: @ventum.cantidad, codigoPro: @ventum.codigoPro, fecha: @ventum.fecha, nombreCli: @ventum.nombreCli, numBoleta: @ventum.numBoleta } }
    end
  ...
  test "should update ventum" do
    patch ventum_url(@ventum), params: { ventum: { cantidad: @ventum.cantidad, codigoPro: @ventum.codigoPro, fecha: @ventum.fecha, nombreCli: @ventum.nombreCli, numBoleta: @ventum.numBoleta } }
