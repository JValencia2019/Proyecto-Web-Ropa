...
class ProveedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proveedor" do
    assert_difference('Proveedor.count') do
      post proveedors_url, params: { proveedor: { correoElectronico: @proveedor.correoElectronico, direccion: @proveedor.direccion, nombre: @proveedor.nombre, rubro: @proveedor.rubro, servicio: @proveedor.servicio, sitioWed: @proveedor.sitioWed, telefono: @proveedor.telefono } }
    end
  ...
  test "should update proveedor" do
    patch proveedor_url(@proveedor), params: { proveedor: { correoElectronico: @proveedor.correoElectronico, direccion: @proveedor.direccion, nombre: @proveedor.nombre, rubro: @proveedor.rubro, servicio: @proveedor.servicio, sitioWed: @proveedor.sitioWed, telefono: @proveedor.telefono } }
