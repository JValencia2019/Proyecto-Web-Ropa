...
class ProveedorsTest < ApplicationSystemTestCase
  ...
  test "creating a Proveedor" do
    ...
    fill_in "Correoelectronico", with: @proveedor.correoElectronico
    fill_in "Direccion", with: @proveedor.direccion
    fill_in "Nombre", with: @proveedor.nombre
    fill_in "Rubro", with: @proveedor.rubro
    fill_in "Servicio", with: @proveedor.servicio
    fill_in "Sitiowed", with: @proveedor.sitioWed
